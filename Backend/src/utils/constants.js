...
module.exports = {
  ...
  CONFIG: {
    ...
    TICK_MS: Number(process.env.TICK_MS) || 30000, // 30 seconds to reduce refresh frequency
    CORS_ORIGIN: process.env.CORS_ORIGIN || "*",
    FLIGHT_COUNT: Number(process.env.FLIGHT_COUNT) || 5 // Increased to 5 live flights
  }
};